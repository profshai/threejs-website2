...
function generatePlane() {
    ...
    for (let i = 0; i < array.length; i++) {
        if (i % 3 === 0) {
            ...
            const y = array[i + 1]
            const z = array[i + 2]
                // Randomize the vertices (we want both negative and positive)
...
// Raycaster monitors when when the mouse touches an object
...
addEventListener('mousemove', (event) => {
    // console.log(event.clientX) gives x position of mouse
